            ...
            if self.use_mock:
                ...
                try:
                    ...
                    if response.choices and len(response.choices) > 0:
                        ...
                        reply = "⚠️ No reply generated from OpenAI."
                        st.warning("⚠️ OpenAI returned an empty response. Check your API usage or quota.")
                        print("⚠️ OpenAI empty response:", response)
