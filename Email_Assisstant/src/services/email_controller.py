        ...
        for msg in messages:
            ...
            if self.use_mock:
                ...
                if response.choices and len(response.choices) > 0:
                    ...
                    reply = "⚠️ No response generated by OpenAI."

            print(f"Generated reply: {reply}")
            to_address_parts = email_content['data'].split()
            if not to_address_parts:
                print(f"⚠️ Warning: No recipient found in email content for email ID {msg['id']}")
                continue
